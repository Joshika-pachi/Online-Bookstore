<?php
	function db_connect(){
		$conn = mysqli_connect("localhost", "root", "Jossyamah@2528", "www_project");
		if(!$conn){
	...
	function setCustomerId($name, $address, $city, $zip_code, $country){
		...
		// Safely insert new customer, skipping the auto-increment field
		...
		$customerid = mysqli_insert_id($conn); // Get the newly inserted ID
		return $customerid;
	}
